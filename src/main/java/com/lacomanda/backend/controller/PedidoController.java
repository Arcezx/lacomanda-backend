...
public class PedidoController {
    ...
    @GetMapping("/sesion/{sesionMesaId}")
    public ResponseEntity<List<PedidoResponseDTO>> findBySesionMesa(@PathVariable String sesionMesaId) {
        return ResponseEntity.ok(pedidoService.findBySesionMesa(sesionMesaId));
    }
    @PostMapping
